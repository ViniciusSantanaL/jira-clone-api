package br.com.iesb.nicetask.infrastructure.security.config;

import br.com.iesb.nicetask.infrastructure.security.service.AuthenticationService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception  {
        http.csrf().disable()
                ...
                .authorizeHttpRequests(authorize -> authorize
                    .requestMatchers("/api/v1/sing-up").permitAll()
